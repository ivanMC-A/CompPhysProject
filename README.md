...
This shows a promising ability for our network to predict behavior of chaotic time-delayed differential systems.

We experienced difficulties implementing the electro-optical delay reservoir network. While the echo state network uses a tanh function to update the reservoir states, we were unable to succesfully implement it in the electro-optic reservoir case. Instead, we used a sin^2 function as detailed in [1].

This resulted in a prediction that doesn't approximate the function succesfully:

![alt text](images/image.png)

Where the respective MSE was:
